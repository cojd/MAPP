const FORM_DEFS = {
  ...
  remeasure: {
    ...
    cards: [
      ...
      {
              id: 'burn_resurvey',
              header: 'Post-Fire Resurvey (click to expand)',
              collapsable: true,
              collapsed: true,
              sections: [
                {
                  inputs: [
                    ...
                    },
                    {
                      ...
                      label: 'Char Severity (Upslope)',
                      html_element: 'input',
                      html_attributes: { type: 'number' },
                    },
                    {
                      column_name: 'char_sideslope1',
                      label: 'Char Severity (Side-slope 1)',
                      html_element: 'input',
                      html_attributes: { type: 'number' },
                    },
                    {
                      column_name: 'char_sideslope2',
                      label: 'Char Severity (Side-slope 2)',
                      html_element: 'input',
                      html_attributes: { type: 'number' },
                    },
                    {
                      column_name: 'char_downslope',
                      label: 'Char Severity (Downslope)',
                      html_element: 'input',
                      html_attributes: { type: 'number' },
                     },
                  ], // inputs
